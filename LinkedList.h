...
// i added this up here because it wouldn't compile
...
// i added this because we needed something here
//template <class Object>
//class ListNode
//{
//public:
//	ListNode() : next(NULL) {}
//	ListNode(Object e, ListNode<Object> *n) : element(e), next(n) {}
//
...
// i moved this above the List class because the List class calls methods on this
template <class Object>
class ListItr
{
public:
	...
	{
		if (isPastEnd()) throw std::runtime_error("bad iterator");
...
// this is down here because of the ListItr friend class with List thing.. i think.
template<class Object>
...
//void List<ItemType>::insert(int index, const ItemType & item) {}
...
//	}
//private:
//	ListNode::ListNode<Object> *current;
//	// Current position
//	ListItr(ListNode<Object> *theNode)
//		: current(theNode) { }
//	friend class List<Object>; // Grant access to constructor
